...
module.exports = configure(function (ctx) {
  return {
    ...
    build: {
      ...
      distDir: 'dist/monitor', // @mimas: change quasar build dir, quasar will clean this folder each time building
      env: {
      ...
      extendWebpack (cfg) {
        cfg.output = {
          ...
          path: resolve(__dirname, 'dist/monitor') // @mimas: where to put all files but index.html (which goes with the distDir setting)
        }
    ...
    pwa: {
      ...
      manifest: {
        name: 'Micro Frontend Monitor',
        short_name: 'Micro Frontend Monitor',
        description: '',
        display: 'standalone',
